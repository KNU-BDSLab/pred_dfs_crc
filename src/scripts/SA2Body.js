...
function SA2Body() {
    ...
    const fetchUsers2 = async () => {
        ...
        const response2 = await axios.get(
            'http://ogyworld.pythonanywhere.com/api3/',
            );
    ...
    const postUsers2 = async () => {
        ...
        axios.post('http://ogyworld.pythonanywhere.com/api3/',{
            title: "title",
            content: "content",
            dfs: dfs,
            siteN: 15,
        }).then(function(response){
            window.location.href = "http://ogyworld.pythonanywhere.com/api3/result/";
        });
        } catch (e) {
        setError2(e);
        }
    ...
    return(
        <div>
            ...
            <br/><br/><br/>
                ...
                <Link to="/sa1"><b style={{fontSize: "15px", marginLeft: "20px", color: "black"}}> Survival analysis - 1</b></Link>
                <Link to="/sa2"><b style={{fontSize: "15px", marginLeft: "20px"}}> Survival analysis - 2</b></Link>
                <br/>
                ...
                {
                    (users2.length != 0) &&
                    (link != "https://ogyworld.github.io/15to6/#/sa2") &&
                    (<img src={users2[users2.length-1].image}/>)
                }
