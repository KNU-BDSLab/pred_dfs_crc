...
function Body2() {
    ...
    const [ys, setYS] = useState("Low");
    const [ul, setUL] = useState("Low");
    ...
    const fetchUsers = async () => {
        ...
        const response = await axios.get(
            'http://ogyworld.pythonanywhere.com/api4/',
            //'http://127.0.0.1:8000/api4/',
            );
    ...
    const postUsers = async () => {
        ...
        axios.post('http://ogyworld.pythonanywhere.com/api4/',{
            ...
            window.location.href = "http://ogyworld.pythonanywhere.com/api4/result/";
            //window.location.href = "http://127.0.0.1:8000/api4/result";
        });
        } catch (e) {
        setError(e);
        }
    ...
    return(
        <div>
            ...
            <br/><br/><br/>
                ...
                {
                    (users.length != 0) &&
                    (link != "https://ogyworld.github.io/15to6/#/") &&
                    (link != "https://ogyworld.github.io/15to6/") &&
